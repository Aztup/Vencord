...
export function getReplaceableGetQuality(connection: types.Connection, get: ProfilableStore<ScreenshareStore, ScreenshareProfile>["get"]) {
    console.log(connection.getQuality);
